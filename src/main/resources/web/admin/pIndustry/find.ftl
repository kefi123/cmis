...
<body>
	...
	<div class="container">
		<table class="table text-info" style="margin-top: 50px;">
			...
			<tbody id="pIndustrys">
				<#list pageInfos.list as pIndustry>
					<tr>
						<td>${pIndustry.p_industry_id}</td>
						<td>${pIndustry.p_industry_name}</td>
						<td><a href='deletePIndustry?p_industry_id=${pIndustry.p_industry_id}' class='btn btn-info'>删除</a>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a href='getPIndustryByID?p_industry_id=${pIndustry.p_industry_id}' class='btn btn-info'>修改</a>
						</td>
					</tr>
				</#list>
			</tbody>
