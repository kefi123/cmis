...
<body>
	...
	<div class="container">
		<form class="form"
			action="getConnectionByName?page=1&size=4"
			...
			<div class="form-group col-md-12">
				<input type="text" class="form-control" placeholder="输入人脉名称"
					name="co_name" style="width: 400px; height: 40px; float: left">
		...
		<table class="table text-info" style="margin-top: 50px;">
			...
			<tbody id="connections">
				<#list pageInfos.list as connection>
					<tr>
						<td>${connection.co_id}</td>
						<td>${connection.co_name}</td>
						<td>${connection.co_mail}</td>
						<td><a href='deleteConnection?co_id=${connection.co_id}'
								 class='btn btn-info'>删除</a>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a href='getConnectionByID?co_id=${connection.co_id}' class='btn btn-info'>修改</a>
						</td>
					</tr>
				</#list>
			</tbody>
