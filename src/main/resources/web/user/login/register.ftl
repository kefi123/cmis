    ...
    <div class="container-fluid" style="background-color: #fcfcfc">
        <div class="row">
            <div class="col-md-6 col-md-offset-3" style="background-color: #fff;margin-top: 50px;margin-bottom: 100px;">
                <div class="row" style="margin-top: 150px;"> <h3 class="col-md-4 col-md-offset-4">注册</h3></div>
                <form action="registerUser" class="form-horizontal" style="margin-top: 50px;">
                    ...
                    <button type="submit" class="btn btn-info" style="width: 307px;margin-top: 30px;margin-left: 230px;">注册</button>
                    <div style="margin-top: 50px;" class="col-md-4 col-md-offset-8">
                        <a href="loginFtl">登录到人脉网吧！</a>
                    </div>
                </form>
            </div>
        </div>
